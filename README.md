...
<strong><div id="Ref-WWW-2020"></div>[4] Gaole He, Junyi Li, Wayne Xin Zhao, Peiju Liuand Ji{-}Rong Wen : Mining Implicit Entity Preference from User-Item Interaction Data for Knowledge Graph Completion via Adversarial Learning. WWW 2020. [paper](https://dl.acm.org/doi/abs/10.1145/3366423.3380155) [code](https://github.com/RUCAIBox/UPGAN)</strong>
